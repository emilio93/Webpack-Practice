...
test("basic test", async ({ page }) => {
  ...
  await page.screenshot({
    path: `screenshot-invalid-input.png`,
    fullPage: true,
  });
  ...
  await sleep(2000);
  await page.screenshot({
    path: `screenshot-invalid-input-email.png`,
    fullPage: true,
  });
  ...
  await sleep(2000);
  await page.screenshot({
    path: `screenshot-invalid-input-password.png`,
    fullPage: true,
  });
  ...
  await sleep(2000);
  await page.screenshot({
    path: `screenshot-before-login.png`,
    fullPage: true,
  });
  ...
  await sleep(2000);
  await page.screenshot({
    path: `screenshot-after-logout.png`,
    fullPage: true,
  });
});
